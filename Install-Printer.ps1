Start-Transcript -Path C:\Temp\Install2Printer.log
<#
.Synopsis
...
.Example
.\Install-Printer.ps1 -PortName "IP_192.168.100.89" -PrinterIP "192.168.100.89" -PrinterName "Canon Printer Upstairs" -DriverName "Canon Generic Plus PCL6" -INFFile "CNP60MA64.inf"
#>
